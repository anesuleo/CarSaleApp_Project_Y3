...
--
-- Host: localhost    Database: carsale
-- ------------------------------------------------------
...
CREATE TABLE `car` (
  ...
  `year` int NOT NULL,
  `car_info_info_id` int DEFAULT NULL,
  PRIMARY KEY (`car_id`),
  UNIQUE KEY `UKlke93w8d791b99obkffy2glo9` (`car_info_info_id`),
  CONSTRAINT `FK30tauyj2co19n7ycakrs51e2r` FOREIGN KEY (`car_info_info_id`) REFERENCES `car_info` (`info_id`)
...
INSERT INTO `car` VALUES (1,2000,'Ford','Focus',2008,NULL),(2,7450,'Ford','Focus',2013,NULL),(3,6000,'Ford','Fiesta',2010,NULL),(4,16000,'Skoda','Octavia',2020,NULL),(5,18000,'Audi','A6',2017,NULL);
...
CREATE TABLE `car_info` (
  ...
  PRIMARY KEY (`info_id`),
  KEY `FKr319deqe0cbxoxjgty2pt2j89` (`car_id`),
  CONSTRAINT `FKr319deqe0cbxoxjgty2pt2j89` FOREIGN KEY (`car_id`) REFERENCES `car` (`car_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-31 16:56:30
